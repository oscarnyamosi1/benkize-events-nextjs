...
const ADMIN_BOOKINGS = [
  ...
  { id: 'BK-002', client: 'Tech Corp Inc.', event: 'Annual Gala', date: '2025-09-01', amount: 'Ksh 1,200,000', status: 'pending' },
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="space-y-3">
            <Button className="w-full justify-start h-12" variant="outline">Create New Booking</Button>
            <Button className="w-full justify-start h-12" variant="outline">Generate Invoice</Button>
            <Button className="w-full justify-start h-12" variant="outline">Manage Staff Schedule</Button>
            <Button className="w-full justify-start h-12" variant="outline">Update Menu Items</Button>
          </div>
        </div>
      </div>
