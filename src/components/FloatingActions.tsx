  ...
  return (
    <div className={`floating-actions${expanded ? " is-expanded" : ""}`}>
      ...
      <div className="fab-menu" aria-hidden={!expanded}>
        <a
          href="https://wa.me/254707091550?text=Hello%20BENKIZ%2C%20I%20would%20like%20to%20inquire%20about%20your%20services."
          target="_blank"
        ...
        <a
          href="mailto:benkizbakers@gmail.com"
        ...
        <a
          href="https://maps.app.goo.gl/rJz2x7UBbK86A3NV6"
          target="_blank"
          rel="noopener noreferrer"
        ...
        {/* 🔥 Orange Pill Review Button */}
        <ReviewButton variant="floating-orange" />
      </div>
    </div>
  );
}